...
export class DocumentacionController {
    ...
    public async validarDocComplementario(req: Request, res: Response) {
        ...
        /** Buscamos en la base de datos si existe un contrato con el nombre proporcionado */
        const findDocumentacionComplementariaById = await DocumentacionController.documentacionComplementariaQueries.findDocumentacionComplementariaById({ id: documentacionComplementariaId });
