...
export class DocumentosAnuenciaController {
    ...
    static documentoAnuenciaQueries: DocumentacionAnuenciaQueries = new DocumentacionAnuenciaQueries()
    ...
    public async updateDocumentacionAneuncia(req: Request, res: Response) {
        ...
        const createDocumento = await DocumentosAnuenciaController.documentoAnuenciaQueries.update({
